...
from mldatasetmanager.conversion.pipeline import convert_coco_to_yolo, convert_yolo_to_coco
...
def convert_dataset(
    ...
    raise ValueError("MVP conversion support is limited to COCO <-> YOLO")
